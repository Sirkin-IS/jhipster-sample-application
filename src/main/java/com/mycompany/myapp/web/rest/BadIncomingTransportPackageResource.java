...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.BadIncomingTransportPackage}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class BadIncomingTransportPackageResource {
    ...
    private static final String ENTITY_NAME = "badIncomingTransportPackage";
