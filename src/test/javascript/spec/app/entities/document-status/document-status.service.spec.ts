...
describe('Service Tests', () => {
  describe('DocumentStatus Service', () => {
    ...
    let elemDefault: IDocumentStatus;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DocumentStatusService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new DocumentStatus(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a DocumentStatus', () => {
        ...
        service.create(new DocumentStatus()).subscribe(resp => (expectedResult = resp.body));
